...
if st.button("Run Models"):
    ...
    observations = {
        "Logistic Regression":        "Served as a reliable baseline model with consistent performance, but its linear nature limits its ability to capture more complex relationships present in the data.",
        ...
        "KNN":        "Produced reasonable results but showed sensitivity to feature scaling and neighborhood size, which affected its stability across different samples.",
